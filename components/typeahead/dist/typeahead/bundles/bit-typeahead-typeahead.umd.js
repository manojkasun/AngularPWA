(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@bit/valor-software.ngx-bootstrap.typeahead/typeahead', ['exports', '@angular/core', 'ngx-bootstrap/utils', 'ngx-bootstrap/positioning', '@angular/animations', 'rxjs/operators', '@angular/forms', 'rxjs', 'ngx-bootstrap/component-loader', '@angular/common'], factory) :
    (global = global || self, factory((global.bit = global.bit || {}, global.bit.typeahead = global.bit.typeahead || {}, global.bit.typeahead.typeahead = {}), global.ng.core, global.utils, global.positioning, global.ng.animations, global.rxjs.operators, global.ng.forms, global.rxjs, global.componentLoader, global.ng.common));
    ...
    var TypeaheadDirective = /** @class */ (function () {
        ...
        function () {
            ...
            try {
                ...
                for (var _b = __values$1(this._subscriptions), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var sub = _c.value;
                    sub.unsubscribe();
                }
            }
...
//# sourceMappingURL=bit-typeahead-typeahead.umd.js.map
